...
<video controls width="100%">
  <source src="../assets/pcb-aoi-incremental_learning.webm" type="video/webm">
  Your browser does not support the video tag.
</video>

▶️ [Download screencast](../assets/pcb-aoi-incremental_learning.webm)

### Execution Result
![Training Loop Screenshot](../assets/pcb-aoi-incremental.png)
